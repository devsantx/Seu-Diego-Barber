  ...
  return (
    <footer style={{ background: COLORS.darkBg, borderTop: `1px solid ${RGBA.gold(0.1)}` }}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-6">
        ...
        >
          ...
          <div
            ...
            style={{ background: `linear-gradient(180deg, transparent, ${RGBA.gold(0.18)}, transparent)` }}
          />
              ...
              <nav className="space-y-2.5">
                {NAV_LINKS.map((link) => (
                  <button
                    ...
                    onMouseLeave={e => e.currentTarget.style.color = COLORS.textMutedDarker}
                  >
                    {link.label}
                  </button>
                ))}
                ...
                {HORARIOS.map(({ dia, hora, fechado }) => (
                  <div key={dia}>
                    <p className="text-[11px]"
                      style={{ color: COLORS.textMutedDark, fontFamily: FONTS.body }}>
                      {dia}
                    </p>
                    <p className="text-[11px] font-semibold"
                      style={{ color: fechado ? COLORS.textDisabled : COLORS.textPanel, fontFamily: FONTS.body }}>
                      {hora}
                    </p>
                  </div>
                ))}
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <a href={waLink} target="_blank" rel="noopener noreferrer"
                    ...
                    onMouseEnter={e => e.currentTarget.style.color = COLORS.gold}
                    onMouseLeave={e => e.currentTarget.style.color = COLORS.textPanel}
                  >
                    (81) 98633-3846
                  </a>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[11px]"
                    style={{ color: COLORS.textPanel, fontFamily: FONTS.body, lineHeight: 1.6 }}>
      ...
      <div
        ...
        style={{ borderTop: `1px solid ${RGBA.gold(0.06)}` }}
      >
        <p className="text-[10px] text-center sm:text-left"
          style={{ color: COLORS.textMutedSoft2, fontFamily: FONTS.body }}>
        ...
        <button
          ...
          onMouseEnter={e => e.currentTarget.style.color = COLORS.gold}
          onMouseLeave={e => e.currentTarget.style.color = COLORS.textMutedSoft3}
        >
          VOLTAR AO TOPO ↑
        </button>
      </div>
