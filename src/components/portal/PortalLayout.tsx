...
const NAV_LINKS = [
  { path: "/portal", label: "INICIO", end: true },
  { path: "/portal/agendar", label: "AGENDAR", end: false },
  { path: "/portal/historico", label: "HISTORICO", end: false },
      ...
      >
        ...
        >
            ...
            {NAV_LINKS.map(link => (
              <NavLink
                ...
                style={({ isActive }) => ({
                  ...
                  color: isActive ? COLORS.gold : "var(--text-body)",
                })}
              >
                {({ isActive }) => (
                  <>
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <button
              className="relative flex items-center justify-center w-10 h-10 rounded-full flex-col gap-[5px]"
          ...
          >
            ...
            >
              <div className="px-6 pt-4 pb-2 border-b" style={{ borderColor: RGBA.gold(0.07) }}>
                <p className="text-[10px] tracking-widest" style={{ color: "var(--text-muted)", fontFamily: FONTS.body }}>
                  BEM-VINDO,
                </p>
                ...
                {cliente?.plano?.ativo && (
                  <span
                    className="inline-block mt-1 px-2 py-0.5 text-[9px] font-bold tracking-widest"
                  ...
                  return (
                    ...
                    >
                      <NavLink
                        ...
                        style={{ borderColor: RGBA.gold(0.07), fontFamily: FONTS.body, color: isActive ? COLORS.gold : "var(--text-body)" }}
                      >
                        {link.label}
