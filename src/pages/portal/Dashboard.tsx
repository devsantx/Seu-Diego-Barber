  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:gap-0">
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6 order-1 lg:order-2"
        ...
        >
          ...
          <div className="grid gap-4">
            <div className="p-5 rounded-2xl relative overflow-hidden" style={{ background: "linear-gradient(135deg, var(--bg-card) 60%, rgba(201,162,74,0.1))", border: `1px solid ${RGBA.gold(0.2)}` }}>
            ...
            <div className="p-5 rounded-2xl cursor-pointer group" style={{ background: `linear-gradient(135deg, ${RGBA.gold(0.1)}, rgba(201,162,74,0.02))`, border: `1px solid ${RGBA.gold(0.25)}` }}>
              <p className="text-[10px] font-bold tracking-[0.28em] mb-2" style={{ color: COLORS.goldDeep, fontFamily: FONTS.title }}>
                AGENDE O SEU PROXIMO CORTE
              </p>
              <p className="text-[12px] mb-4" style={{ color: "var(--text-muted)", fontFamily: FONTS.body }}>
                {plano?.ativo ? `Voce tem ${cortesRestam} corte(s) disponivel(is) no plano. Agende para garantir seu horario.` : "Agende um corte avulso ou assine um plano para ter prioridade."}
              </p>
        ...
        <motion.div
          className="p-5 rounded-2xl order-2 lg:order-1"
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap mb-4">
            <div>
              ...
              <p className="text-[11px] mt-1" style={{ color: "var(--text-muted)", fontFamily: FONTS.body }}>
                O que voce ja reservou aparece aqui assim que entrar no portal.
              </p>
            </div>
